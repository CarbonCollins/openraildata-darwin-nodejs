...
const { Schedule, Association, TrainOrder, StationMessage, TrainStatus } = require('openraildata-common');
          ...
          switch(type) {
            case 'TRAINSTATUS,':
              ...
              this.emit('trainStatus', {
                ...
                trainStatus: new TrainStatus(messageJSON.Pport.uR.TS),
            ...
            case 'SCHEDULE,':
              ...
              this.emit('schedule', {
                ...
                ts: messageJSON.Pport.ts,
                schedule: new Schedule(messageJSON.Pport.uR.schedule),
                origin: messageJSON.Pport.uR.updateOrigin,
            ...
            case 'ASSOCIATION,':
              ...
              this.emit('association', {
                id: messageJSON.Pport.uR.requestID,
                ts: messageJSON.Pport.ts,
                association: new Association(messageJSON.Pport.uR.association),
                origin: messageJSON.Pport.uR.updateOrigin,
                source: messageJSON.Pport.uR.requestSource
              });
              break;
            case 'TRAINORDER,':
              ...
              this.emit('trainOrder', {
                id: messageJSON.Pport.uR.requestID,
                ts: messageJSON.Pport.ts,
                trainOrder: new TrainOrder(messageJSON.Pport.uR.trainOrder),
                origin: messageJSON.Pport.uR.updateOrigin,
                source: messageJSON.Pport.uR.requestSource
              });
              break;
            case 'STATIONMESSAGE,':
              ...
              this.emit('stationMessage', {
                ts: messageJSON.Pport.ts,
                stationMessage: new StationMessage(messageJSON.Pport.uR.OW),
                origin: messageJSON.Pport.uR.updateOrigin
              });
              break;
            default: 
